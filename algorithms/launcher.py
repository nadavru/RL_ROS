...
if __name__ == '__main__':
    ...
    chosen_params = params.all_parameters[alg]
    Policy = Policies[chosen_params["algorithm"]]
    Trainer = Trainers[chosen_params["algorithm"]]

    policy = Policy(**chosen_params)
    trainer = Trainer(**chosen_params, device=device)
